  ...
  return (
    <div className="reg-container">
      ...
      <div className="reg-steps">
        ...
        <span className={step === 3 ? "active" : ""}>Family Details</span>
        <span className={step === 4 ? "active" : ""}>Documents</span>
        <span className={step === 5 ? "active" : ""}>Hostel</span>
        <span className={step === 6 ? "active" : ""}>Disclaimer</span>
        <span className={step === 7 ? "active" : ""}>Register</span>
      </div>
    ...
    <option key={s} value={s}>{s}</option>
        ...
        <>
          ...
          <div className="grid">
            ...
            Community<input placeholder="community" />
            <div className="doc-item">
              <label>Community Certificate</label>
              <input type="file" />
            </div>
            <select value={firstGraduate} onChange={e => setFirstGraduate(e.target.value)}>
...
{firstGraduate === "Yes" && (
 ...
 <label>Nativity Certificate</label>
  <input
    ...
    onChange={(e) => setNativityCert(e.target.files[0])}
  />
          </div>
